...
with open(lemma_path, "w", newline='', encoding="utf-8") as lemma_file, \
    ...
    lemma_writer.writerow(["Original Sentence", "Lemmatized Tokens", "Lemmatized Sentence"])
    stem_writer.writerow(["Original Sentence", "Stemmed Tokens", "Stemmed Sentence"])
    ...
    for i, sentence in enumerate(sentences):
        ...
        lemma_writer.writerow([sentence, ", ".join(lemmatized), " ".join(lemmatized)])
        stem_writer.writerow([sentence, ", ".join(stemmed), " ".join(stemmed)])
